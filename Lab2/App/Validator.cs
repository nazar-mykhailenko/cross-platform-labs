namespace App
{
    public class Validator
    {
        ...
        private void CheckInputIsValid()
        {
            ...
            {
                throw new System.ArgumentException("N must be between 1 and 1000");
            }

            if (_inputData.K < 1 || _inputData.K > _inputData.N)
            {
                throw new System.ArgumentException("K must be between 1 and N");
            }

            if (_inputData.W < 1)
            {
                throw new System.ArgumentException("W must be greater than 0");
            }

            if (_inputData.S < 1 || _inputData.S > _inputData.W)
            {
                throw new System.ArgumentException("S must be between 1 and W");
            }

            if (_inputData.ForbiddenWeekdays.Count > _inputData.W)
            {
                throw new System.ArgumentException("Forbidden weekdays count must be less than or equal to W");
            }

            if (_inputData.ForbiddenMonthDays.Count > _inputData.N)
            {
                throw new System.ArgumentException("Forbidden month days count must be less than or equal to N");
            }
            ...
            foreach (int weekday in _inputData.ForbiddenWeekdays)
            {
                ...
                {
                    throw new System.ArgumentException("Forbidden weekday must be between 1 and W");
                }
            }
            ...
            foreach (int monthDay in _inputData.ForbiddenMonthDays)
            {
                ...
                {
                    throw new System.ArgumentException("Forbidden month day must be between 1 and N");
                }
            }
        }
